...
void patientsMenu()
{
    ...
    while (!exit)
    {
        ...
        if (purpose == 1)
        {
            if(identity != 1 && identity != 3 && identity != 4)
            {
                cout<<"No Permission!\n";
            }
            else
...
int main()
{
    ...
    while((identity < 1 || identity > 5) && identity != -1)
    {
        cout << "\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n";
        ...
        if(identity == 1)
        {
            ...
            getline(cin, password);
            const char *passwd = password.data();
            if(strcmp(passwd, "123456") == 0)
            {
                cout<<"Identity verfication passed!\n";
            }
            else
            {
        ...
        {
            cout<<"Identity verfication passed!\n";
            cout<<"Welcome!Your identity is patient.\n";
        }
        else if(identity == 3)
        {
            cout<<"Identity verfication passed!\n";
            cout<<"Welcome!Your identity is doctor.\n";
        }
        else if(identity == 4)
        {
            cout<<"Identity verfication passed!\n";
            cout<<"Welcome!Your identity is nurse.\n";
        }
        else if(identity == 5)
        {
            cout<<"Identity verfication passed!\n";
            cout<<"Welcome!Your identity is driver.\n";
        }
        else if(identity == -1)
        {
            return 0;
